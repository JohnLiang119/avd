...
- [x] 16.6 建置驗證通過後，功能修正與版本進版各自一個 commit，並同步更新 `avd_s/publish_all.ps1` 的預設 `$Message`

  功能 commit `18c8b86`；版本 1.0.119 → 1.0.120（versionCode 157），七處版號與 `publish_all.ps1` 預設 `$Message` 已同步。
